...
java -Dlog4j.configurationFile="${logFile}" -classpath "${pathToGeoApi}/${classes}:${pathToGeoApi}/${lib}"  gov.nysenate.sage.scripts.admin.MassRegeocacheCLI $1 $2 true $3 $4
echo Method regeocache complete with args $1 $2 true $3 $4