...
public class DistrictShapefileDaoTest extends TestBase
{
    ...
    public void setsDistrictProximityTest()
    {
        ...
        assertNotNull(dinfo.getDistProximity(DistrictType.ZIP));
    }

    @Test
    public void getDistrictOverlapTest()
    {
        dsDao.getDistrictOverlap(DistrictType.SENATE,
                new HashSet<String>(Arrays.asList("44", "46")), DistrictType.ZIP,
                new HashSet<String>(Arrays.asList("12203", "12205")));
    }
    ...
    public void getIntersectingStreetLineTest()
    {
        ...
        assertNotNull(dsDao.getIntersectingStreetLine(DistrictType.SENATE, new HashSet<String>(Arrays.asList("11", "14", "15")), jsonGeom));
    }
}
