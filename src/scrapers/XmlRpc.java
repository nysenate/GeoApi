...
public class XmlRpc {
	...
	public static void main(String[] args) throws Exception {
		...
		for(Object o:objects) {
			...
			String sPicture = (String)sPictureMap.get("filepath");
			...
			System.out.println("sPicture: " + sPicture);
			System.out.println("sFacebook: " + sFacebook);
			System.out.println("sTwitter: " + sTwitter);
			System.out.println("sYoutube: " + sYoutube);
			System.out.println("sFlickr: " + sFlickr);		
			...
			for(Object location:locations) {
				...
				System.out.println("sStreet: " + sStreet);
				System.out.println("sCity: " + sCity);
				System.out.println("sProvince: " + sProvince);
...
//			System.out.println("\n\n\n\n\n\n NODE");
//			
//			HashMap<String,Object> senMap = (HashMap<String, Object>) rpc.getNode(new Integer((String)map.get("nid")));
//						
...
//						System.out.println("-->" + key2 + ": " + ((HashMap<String,Object>)senMap.get(key)).get(key2));
//					}
//				}
//				else {
