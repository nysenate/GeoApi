...
<head>
  ...
  $(document).ready(function() {
      ...
      // Zoom to a blank map of NY.  NOTE: We used to do this only if
      // no district was specified.  However, it seems necessary to
      // do this when an SD is specified in order to force the map to
      // center properly.  Otherwise, OpenLayers tries to center based on
      // the markers.
      ...
      if (point_data.length != 0) {
        ...
        if (navoff == null) {
          ...
          for (var i in office_data) {
            ...
            officeMarker.popup = new OpenLayers.Popup.FramedCloud(
              "Office Data",
              officeMarker.lonlat,
