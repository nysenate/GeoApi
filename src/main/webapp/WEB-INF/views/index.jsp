...
<sage:wrapper>
    ...
    <jsp:body>
            ...
            <ul class="top-method-header">
                <li>
                    <a class="active" ng-click="toggleMethod(1)">
                        <div ng-show="index == 1" class="icon-white-no-hover icon-search"></div>&nbsp;&nbsp;District
                        Lookup
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a ng-click="toggleMethod(3)">
                        <div ng-show="index == 3" class="icon-white-no-hover icon-directions"></div>&nbsp;&nbsp;Street
                        Finder
                    </a>
                </li>
                <li ng-click="toggleMethod(4)">
                    <a>
                        <div ng-show="index == 4" class="icon-white-no-hover icon-target"></div>&nbsp;&nbsp;Reverse
                        Geocode
                    </a>
                </li>
                <li>
        ...
        <div id="contentcolumn" style="display:none;">
                ...
                <div id="streetViewFrame">
                    <div id="streetLookupSearch">
                        ...
                        <div style='padding:10px;'>
                            <p>SAGE provides a database of NYS street ranges that are associated with legislative
                                district codes.</p>
            ...
            <div id="districtInfoSearch" class="search-container" ng-controller="DistrictInfoController"
                 ng-show="visible">
                <form id="districtsFormMini" method="post" ng-submit="lookup()">
                    ...
                    <div ng-click="minimized=true;" ng-hide="minimized"
                         class="collapse-search icon-arrow-up4 icon-hover-teal small-right-icon"></div>
                    <div ng-click="minimized=false;" ng-show="minimized"
                         class="expand-search icon-arrow-down4 icon-hover-teal small-right-icon"></div>
                    <br/>
                    <div class="search-container-content">
                        <div style='margin-top:5px'>
                            <input id="addressInput" type="text" ng-model="addr"
                        ...
                        <div class="options-link-container" ng-hide="showOptions" ng-click="showOptions=true"
                             style="padding-left:5px;border-right:1px solid #ddd">
                            <a class="options-link">Options</a>
                        </div>
                        <div class="options-link-container" ng-show="showOptions" ng-click="showOptions=false"
                             style="padding-left:5px;border-right:1px solid #ddd">
                            <a class="options-link">Hide options</a>
                        </div>

                        <div class="options-link-container" ng-hide="showHelp" ng-click="showHelp=true"
                             style="padding-left:10px;">
                            <a class="options-link">Help</a>
                        </div>
                        <div class="options-link-container" ng-show="showHelp" ng-click="showHelp=false"
                             style="padding-left:10px;">
            ...
            <div id="districtMapViewSearch" class="search-container" ng-show="visible"
                 ng-controller="DistrictMapController">
                ...
                <form id="revGeoForm" method="post">
                    ...
                    <div class="section search-container-content">
                        <div style="float:left">
                            ...
                            <input id="revGeoLatInput" type="text" style="width:80px;margin-right:5px;" ng-model="lat"
                                   name="lat">
                        </div>
                        <div style="float:left">
                            <label for="revGeoLonInput" class="menu-overhead">Longitude</label>
                            <input id="revGeoLonInput" type="text" style="width:80px;margin-right:5px;" ng-model="lon"
                                   name="lon">
                        </div>
                        <div style="float:left">
        ...
        <div ng-click="toggleResultPane(true);" id="showResultsTab" class="result-header success"
             ng-controller="ResultsViewController">
                ...
                <div id="district-results" ng-show="visible" ng-controller="DistrictsViewController"
                    ...
                    <div style="border-bottom:1px solid #ddd" class="info-container connected" ng-show="geocoded">
                        <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <td><p style="font-size: 16px;color:teal;">({{geocode.lat | number:6}}, {{geocode.lon |
                                    number:6}})</p></td>
                    ...
                    <div class="info-container connected-top slim">
                        ...
                        such as the city and zip code. <span ng-show="placeSuggestions.length">You can also try some suggestions listed below: </span></span>
                            <ul style="padding: 5px;margin: 5px auto;" ng-repeat="ps in placeSuggestions">
                                <li style="font-size:14px;"><a ng-click="requestDistrictInfo(ps.description);">{{ps.description}}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div ng-show="senateAssigned">
                                ...
                                <table class="senator-info-district-result">
                                    <tr>
                                        ...
                                        <td class="right-icon-placeholder">
                                            <a title="Show Map" ng-show="districts.senate.map"
                                               ng-click="showDistrict('senate');">
                        ...
                        <div class="info-container connected slim" ng-show="districts.senate.member.offices.length">
                            <table style="width:100%">
                                <tr>
                                    <td>
                                        <a ng-hide="showOffices" ng-click="showOffices=true;">Senator Office
                                            Locations</a>
                                        <a ng-show="showOffices" ng-click="showOffices=false;">Senator Office
                                            Locations</a>
                                    </td>
                                    <td class="right-icon-placeholder">
                                        <a ng-hide="showOffices" ng-click="showOffices=true;">
                                            <div class="icon-arrow-down4 icon-hover-teal"></div>
                                        </a>
                                        <a ng-show="showOffices" ng-click="showOffices=false;">
                                ...
                                <div style="padding:5px;border-top:1px solid #ddd;font-size:14px;"
                                    ...
                                    <table style="width:100%">
                                        <tr>
                                            ...
                                            <td class="right-icon-placeholder">
                                                <a title="Locate office" ng-show="office.point" ng-click="setOfficeMarker(office);">
                    ...
                    <div id="multi-senate-results" ng-show="overlaps && (visible || overlaps.length > 1)">
                        ...
                        <span class="message" ng-switch="matchLevel">
                            <span ng-switch-when="REGION">This approximated area contains multiple {{intersectTypeDisplayName}} Districts.</span>
                        ...
                        <div>
                            <div class="info-container" style="height:70px;">
                                ...
                                <div style="margin-top:10px">
                                    ...
                                    <p class="senate district">{{name}}</p><br/>
                                </div>
                            </div>
