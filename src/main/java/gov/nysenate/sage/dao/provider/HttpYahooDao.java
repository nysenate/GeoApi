...
public class HttpYahooDao
{
    ...
    private Logger logger = LoggerFactory.getLogger(HttpYahooDao.class);
    ...
    @Autowired
    public HttpYahooDao(BaseDao baseDao, Environment env)
    {
    ...
    private GeocodedAddress getGeocodedAddressFromResultNode(JsonNode resultNode)
    {
        ...
        Geocode resultGeocode = new Geocode(new Point(lat, lng), quality, HttpYahooDao.class.getSimpleName());
