...
public enum SqlGeocacheQuery implements BasicSqlQuery {
    ...
    INSERT_CACHE_ENTRY(
            "INSERT INTO public.geocache (bldg_id, street, postal_city, state, zip5, zip4, latlon, method, quality) " +
            "VALUES (:bldgId, :street, :postalCity, :state, :zip5, :zip4, ST_GeomFromText( :latlon ), :method, :quality)"),
