...
public record IntersectResponse(List<DistrictOverlapView> overlaps, String intersectType,
    ...
    public static IntersectResponse from(IntersectResult intersectResult) {
        ...
        return new IntersectResponse(overlaps, intersectResult.getMainMap().getDistrictType().name(),
