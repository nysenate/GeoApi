    ...
    public static void main(String args[]) throws IOException {
        ...
        if (args.length > 0) {
            ...
            if (!sqlFile.exists()) {
                ...
                outputWriter.print("COPY public.streetfile (street, town, state, zip5, bldg_lo_num, bldg_lo_chr, bldg_hi_num, bldg_hi_chr, bldg_parity, " +
                                "election_code, county_code, assembly_code, senate_code, congressional_code, boe_town_code, " +
