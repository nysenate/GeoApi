...
| Param       | Description                                                                   |
+=============+===============================================================================+
| provider    | Specify which district provider to use.                                       |
+-------------+-------------------------------------------------------------------------------+
...
The neighbors array will be of the following format regardless of district type ( ``...`` represents truncated output )::

    /api/v2/district/assign?addr=280 Madison Ave, NY
...
The ``geom`` will be populated if ``showMaps`` is set to true::

    /api/v2/district/assign?addr=280 Madison Ave, NY&showMaps=true

    "map" : {
            "geom" : [ [ [ 40.732752,  -74.019809 ], [ .. ] ] ]
    }
...
A full description of status codes can be found >>>here<<<
